...
(function () {
    ...
    var app = angular.module('BlurAdmin.pages.statistics').controller('StatisticCtrl', StatisticCtrl);
    ...
    function StatisticCtrl($scope, $filter, editableOptions, editableThemes, baConfig, toastr, layoutPaths, Utils, $timeout, $rootScope, PROGRESSBAR_COLOR, API, ngProgressFactory) {
        ...
        $scope.btnStatistic = function (type) {
            ...
            API.getData(obj, 2, function (err, response) {
                ...
                AmCharts.makeChart('hum-chart', Utils.buildChartOptions(Utils.getStatisticChartOptions({ title: 'Độ ẩm', value: values.sort(function (a, b) {
                        return a._id - b._id;
            ...
            API.getData(obj, 0, function (err, response) {
                ...
                // var opts = 
                AmCharts.makeChart('temp-chart', Utils.buildChartOptions(Utils.getStatisticChartOptions({ title: 'Nhiệt độ', value: values.sort(function (a, b) {
                        return a._id - b._id;
                    }), range: { min: range[0], max: range[1] } })));
            ...
            API.getData(obj, 1, function (err, response) {
                ...
                AmCharts.makeChart('aqi-chart', Utils.buildChartOptions(Utils.getStatisticChartOptions({ title: 'Chỉ số không khí', value: values.sort(function (a, b) {
                        return a._id - b._id;
                    }), range: { min: range[0], max: range[1] } })));
            });
